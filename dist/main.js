...
/* harmony export */   storeListItemTitle: () => (/* binding */ storeListItemTitle),
...
function storeListItemTitle(event) {
  const sanitizedValue = (0,_dom__WEBPACK_IMPORTED_MODULE_2__.sanitizeUserData)(event.target.textContent);
  const activeListItemId = (0,_dom__WEBPACK_IMPORTED_MODULE_2__.getElementId)(event.target.parentNode);
  updateOrRemoveListItem(activeListItemId, sanitizedValue, event);
}

function updateOrRemoveListItem(itemId, itemTitle, event) {
...
function removeListItemById(itemId) {
  ...
  (0,_dom__WEBPACK_IMPORTED_MODULE_2__.updateContent)(activeProject);
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   handleListItemTitleInteraction: () => (/* binding */ handleListItemTitleInteraction)
/* harmony export */ });
...
function initializeProjectNavigation() {
  ...
  nav.addEventListener("click", (event) => {
    if (event.target.tagName === "A") {
      ...
      (0,_dom__WEBPACK_IMPORTED_MODULE_1__.updateContent)(projectObject);
    }
  });
}
...
(function initializeNewTaskButton() {
  ...
  newTaskButton.addEventListener("click", () => {
    const activeProjectObject = (0,_data__WEBPACK_IMPORTED_MODULE_2__.getActiveProject)();
    (0,_data__WEBPACK_IMPORTED_MODULE_2__.createAndStoreNewListItem)();
    (0,_dom__WEBPACK_IMPORTED_MODULE_1__.updateContent)(activeProjectObject);
  });
})();

/* Make the title  */
function handleListItemTitleInteraction() {
  ...
  content.addEventListener("input", (event) => {
    if (event.target.matches(".list-item__name")) {
      (0,_data__WEBPACK_IMPORTED_MODULE_2__.storeListItemTitle)(event);
    }
  });

  content.addEventListener("focusout", (event) => {
    if (event.target.matches(".list-item__name")) {
      const listItemId = (0,_dom__WEBPACK_IMPORTED_MODULE_1__.getElementId)(event.target.parentNode);
  ...
  content.addEventListener("keydown", (event) => {
    if (event.target.matches(".list-item__name") && event.key === "Enter") {
      if (event.target.textContent !== "") {
        event.preventDefault();
        const newListItemId = (0,_data__WEBPACK_IMPORTED_MODULE_2__.createAndStoreNewListItem)(); // returns the new list item's id
        (0,_dom__WEBPACK_IMPORTED_MODULE_1__.updateContent)(activeProject);
        (0,_dom__WEBPACK_IMPORTED_MODULE_1__.focusElementAndClearContent)(newListItemId);
      } else {
        const listItemId = (0,_dom__WEBPACK_IMPORTED_MODULE_1__.getElementId)(event.target.parentNode);
        (0,_data__WEBPACK_IMPORTED_MODULE_2__.removeListItemById)(listItemId);
        (0,_dom__WEBPACK_IMPORTED_MODULE_1__.updateContent)(activeProject);
      }
    }
