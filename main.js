...
function createAndStoreNewListItem() {
  ...
  const newListItem = new _todoListItemClass__WEBPACK_IMPORTED_MODULE_0__.TodoListItem(project.id, "New Task");
  project.array.push(newListItem);
  (0,_dom__WEBPACK_IMPORTED_MODULE_2__.populateContent)(project);
}

/* Function to change the  title of a list item if it is edited by the user */
function storeListItemName(event) {
  let value = event.target.textContent;
  const sanitizedValue = dompurify__WEBPACK_IMPORTED_MODULE_3___default().sanitize(value);
  const activeListItemId = (0,_dom__WEBPACK_IMPORTED_MODULE_2__.getDataItemtId)(event.target.parentNode);
...
/* harmony export */   getDataItemtId: () => (/* binding */ getDataItemtId),
/* harmony export */   getDataProjectId: () => (/* binding */ getDataProjectId),
/* harmony export */   getListItemNameFields: () => (/* binding */ getListItemNameFields),
...
function getListItemNameFields() {
  const content = getContent();
...
function populateContent(project) {
  ...
  if (project.array.length > 0) {
    project.array.forEach((listItem) => {
      ...
      (0,___WEBPACK_IMPORTED_MODULE_0__.activateListItemNameField)();
    });
  }
}
...
function setProjectHeadline() {
  ...
  headline.textContent = (0,_data__WEBPACK_IMPORTED_MODULE_1__.getActiveProject)().name;
}
...
function getDataItemtId(element) {
...
function activateListItemNameField() {
  const listItemNameFields = (0,_dom__WEBPACK_IMPORTED_MODULE_1__.getListItemNameFields)();

  listItemNameFields.forEach((field) => {
    field.addEventListener("input", _data__WEBPACK_IMPORTED_MODULE_2__.storeListItemName);
  });
